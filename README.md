...
> **Note**
> Information on how to determine an item's `AppID`, `ContextID`, and `ClassID` may be found (https://github.com/Citrinate/BoosterManager/blob/master/BoosterManager/Docs/ItemIDs.md).
